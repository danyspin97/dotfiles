...
local language_servers = { "rust_analyzer", "pyright", "clangd" } -- or list servers manually like {'gopls', 'clangd'}
...
dap.adapters.codelldb = {
	...
	executable = {
		...
		command = "/home/danyspin97/proj/coding/codelldb_adapter/extension/adapter/codelldb",
		args = { "--port", "${port}" },
	},
}
